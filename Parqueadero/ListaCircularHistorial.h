...
public:
   ...
   void limpiarLista();
    void ingresarVehiculo(int puesto,string placa, string cedula, string nombre,string nombre2, string apellido, string apellido2,string fecha, string horaIngreso);
    ...
    void buscarPorHoras(const string& horaInicio, const string& horaFin);
